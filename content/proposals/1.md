...
Once pallet_content exists it will be possible to create "content parachains" that use Kusama as their relay chain. For example:
...
* name: Jonathan Brown (author of the original MIX contracts)
