+++
title = "Kusama Treasury Proposal: Implement a Kusama Forum (Content Pallet v2)"
description = "A decentralised, common good, on-chain publishing platform coordinating the future of the canary built on existing and emerging community developed tools and technologies."
...
A decentralised, common good, on-chain publishing platform coordinating the future of The Canary built on existing and emerging community developed tools and technologies.
...
Supporting Agents: Daniel Olano (Virto Network), Alain Brenzikofer (Encointer), Treasury Guardians, Paradox, David Barinas (Bloque), Karim Jedda (Parity)
...
This proposal builds on 10 years of work done by Jonathan (ethernomad) and has been developed in collaboration with a number of trusted Kusama agents who have each committed to publishing their own material to the forum proving out initial demand. 
