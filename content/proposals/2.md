+++
title = "Kusama Treasury Proposal: Implement Kusama Forum"
description = ""
...
A decentralised, on-chain publishing platform for coordinating the future of the canary.  

```
Track: MediumSpender
Requested KSM: 768 KSM (~10,800 USD)
```

Proponent: ethernomad, (?)

Signatories: Daniel Olano (Virto Network), Alain Brenzikofer (Encointer), Treasury Guardians, Paradox, 


Project Category/Type: Ecosystem collaboration

Previous funding: Jonathan has been previously funded by two (1, 2) Web3 Foundation grants and a Kusama Treasury referenda.
...
With the community approving the W3F’s [new vision](https://kusama.subsquare.io/referenda/498) for an independent Kusama alongside a commitment of 10m DOT for kickstarting radical innovation the community needs a dedicated space for discussion, coordination and onboarding talent. 

In the spirit of Kusama, we believe that we should use this opportunity to dog food the network’s technology and drive the burning of KSM by developing a fully on-chain forum and publishing platform that can release the potential of existing and incoming contributors. 

This proposal builds on 10 years of work done by Jonathan (ethernomad) and has been developed in collaboration with a number of trusted Kusama agents who have each committed to publishing an example post of their choice to demonstrate an MVP of this project. 
...
A key component of this proposal is to port of functionality from the MIX smart contracts into a Substrate pallet called pallet_content. This pallet would be available for any Substrate chain to add to their runtime.
...
### Kusama Forum Parachain

The Kusama Forum parachain will be launched with the following features:

* No native token - use KSM to pay for transactions.
* [On Demand](https://wiki.polkadot.com/learn/learn-parachains/#on-demand-parachains) Kusama Parachain
...
* Sign in will be handled by [Virto Connect](https://kusama.subsquare.io/referenda/587)
...
The proposal is just the starting point. Once it is live it is inevitable that the community will be very vocal about their ideas of how things should proceed.
...
The deliverables will be completed by the end of November 2025.
