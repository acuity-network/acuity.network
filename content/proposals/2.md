...
MVP beta testers: [Daniel Olano (Virto Network)](https://kusama.subsquare.io/user/EvoLanodoqDsgHb98Ymbu41uXXKfCPDKxeM6dXHyJ2JoVus/posted/referenda), [Treasury Guardians](https://kusama.subsquare.io/user/EVJwhL69kqLYSKKqjsW5J96G4hM3fg5NvoNuYtnH7WYyNG6/posted/referenda), [Pablo Dorado (Virto Network / Polkadot Fellowship)](https://kusama.subsquare.io/user/HUf7Nvfhp85yFZm31zV2ux8h1946Bzzmos2jqGGhp3bWXD4/posted/referenda), [Flipchan (Kusama Shield)](https://kusama.subsquare.io/user/5HdRaUshTGoQFatoJ7Wg9Skg7BLCjfJaV5V9qYNoqR7zfX5B/posted/comments)
...
* low security
* low scalability - EVM, IPFS hashes stored in state
* slow confirmation ~14 sec
* centralized exchanges

Kusama solves all these issues:
* relay chain for shared security
* parachains, native pallets, agile coretime, elastic scaling, JAM, and emiting IPFS hashes as events provides massive scalability gains
...
The original [MIX smart contract](https://github.com/acuity-network/acuity-contracts/blob/master/src/acuity-trusted-accounts/AcuityTrustedAccounts.sol) has already been ported to the [Trusted Accounts pallet](https://github.com/acuity-network/acuity-trusted-accounts-pallet). A video of Trusted Accounts in action can be seen [here](https://www.youtube.com/watch?v=j8WfGYxBERo).
...
<img src="/screenshots/7.jpg" style="width: 100%; height: auto;">
<img src="/screenshots/8.jpg" style="width: 100%; height: auto;">
<img src="/screenshots/9.jpg" style="width: 100%; height: auto;">
<img src="/screenshots/10.jpg" style="width: 100%; height: auto;">
